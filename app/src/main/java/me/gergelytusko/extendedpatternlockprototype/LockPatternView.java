...
public class LockPatternView extends View{
    ...
    public static interface OnPatternListener {
         ...
         */
        void onPatternDetected(List<Cell> pattern, PatternLockSession patternLockSession);
    }
    ...
    private void notifyPatternDetected() {
        ...
        if (mOnPatternListener != null) {
            mOnPatternListener.onPatternDetected(mPattern, patternLockSession);
        }
    }
    ...
    private Cell detectAndAddHit(float x, float y, MotionEvent event) {
        ...
        if (cell != null) {
            ...
            if (fillInGapCell != null &&
                ...
                PatternLockSensorData a = new PatternLockSensorData(patternLockSensorManager.getPatternLockSensorData());
